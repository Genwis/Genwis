    ...
    return (
      <View style={container1} >
        <View style={container2}>
          ...
          <TextInput placeholder="genwis@mailinator.com" style={inputan} underlineColorAndroid="#27ae60" />
          <Text style={KTP}>
                        No. Identity (KTP/Paspor/SIM)
          </Text>
          <TextInput placeholder="10016416426457891267" style={inputan} underlineColorAndroid="#27ae60" />
        </View>
